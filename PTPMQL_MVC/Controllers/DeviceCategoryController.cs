...
namespace PTPMQL_MVC.Controllers
{
    public class DeviceCategoryController : Controller
    {
        ...
        {
            return View(await _context.DeviceCategory.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var deviceCategory = await _context.DeviceCategory
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var deviceCategory = await _context.DeviceCategory.FindAsync(id);
            if (deviceCategory == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.DeviceCategory.Any(e => e.CategoryId == id);
        }
    }
}
