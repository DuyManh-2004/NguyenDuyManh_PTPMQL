...
namespace PTPMQL_MVC.Controllers
{
    public class DeviceController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Device.Include(d => d.Category).Include(d => d.Supplier);
        ...
        {
            ViewData["CategoryId"] = new SelectList(_context.Set<DeviceCategory>(), "CategoryId", "CategoryName");
        ...
        public async Task<IActionResult> Create([Bind("DeviceId,DeviceName,Price,Stock,CategoryId,SupplierId")] Device device)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Set<DeviceCategory>(), "CategoryId", "CategoryName", device.CategoryId);
            ViewData["SupplierId"] = new SelectList(_context.Set<Supplier>(), "SupplierId", "SupplierName", device.SupplierId);
            return View(device);
        }
