...
namespace PTPMQL_MVC.Controllers
{
    public class ImportReceiptController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ImportReceiptID,ImportDate,SupplierID")] ImportReceipt importReceipt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImportReceiptID,ImportDate,SupplierID")] ImportReceipt importReceipt)
        {
