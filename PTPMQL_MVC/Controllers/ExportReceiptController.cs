...
namespace PTPMQL_MVC.Controllers
{
    public class ExportReceiptController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExportReceiptID,ExportDate")] ExportReceipt exportReceipt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExportReceiptID,ExportDate")] ExportReceipt exportReceipt)
        {
